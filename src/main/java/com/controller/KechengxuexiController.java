...
public class KechengxuexiController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechengxuexiEntity kechengxuexi, 
		...
		if(tableName.equals("jiaoshi")) {
			kechengxuexi.setGonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<KechengxuexiEntity> wrapper = new EntityWrapper<KechengxuexiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = kechengxuexiService.selectCount(wrapper);
