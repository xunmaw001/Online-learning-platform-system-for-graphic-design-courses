<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="在线测试名称" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="在线测试名称" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="在线测试名称" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="在线测试名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="在线测试状态" prop="status">
        ...
        <div v-else>
          <el-form-item class="input" label="在线测试状态" prop="status">
