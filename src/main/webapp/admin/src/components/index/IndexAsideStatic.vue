      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          ...
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "linear-gradient(180deg, rgba(65,157,170,1) 0%, rgba(65,157,170,1) 8%, rgba(255,255,255,1) 9%, rgba(255,255,255,1) 12%, rgba(65,157,170,1) 12%, rgba(65,157,170,1) 100%)"
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(147, 212, 215, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
